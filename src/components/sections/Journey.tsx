  ...
  return (
    ...
    >
      <FadeIn>
        ...
        <div className="flex pt-[7.25rem] pl-[1.2rem]">
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <div className="size-[1rem] rounded-full bg-accent"></div>
                      <div className={`w-[2px] flex-1 ${index === journeyTrack.length-1 ? 'bg-transparent' : 'bg-accent'}`}></div>
                    </div>
                    <div className="flex flex-col pt-[1.75rem] pb-[1.75rem]">
                      <span className="font-code text-sm text-accent">{item.year}</span>
                      <h3 className="font-korean font-semibold text-2xl">{item.title}</h3>
                      <span className="font-korean text-base text-secondary">{item.desc}</span>
                    </div>
                  </li>
                )
              })}
